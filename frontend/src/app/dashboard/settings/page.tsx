...
function SettingsContent() {
  ...
  const [isDevAccordionOpen, setIsDevAccordionOpen] = useState(false);
  ...
  return (
    <div className="space-y-6 max-w-[1360px] mx-auto animate-fadeIn pb-16">
      ...
      {/* Form Container & Balanced 2-Column Workspace */}
      <form onSubmit={handleSaveSettings}>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start min-h-[calc(100vh-14rem)]">
          {/* Left Column: Contextual Architecture & Security Guide */}
          ...
          {/* Right Column: Active Tab Configuration & Anchored Action Bar */}
